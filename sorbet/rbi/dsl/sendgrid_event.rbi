...
# This is an autogenerated file for dynamic methods in `SendgridEvent`.
# Please instead update this file by running `bin/tapioca dsl SendgridEvent`.
...
class SendgridEvent
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::SendgridEvent).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end
    ...
    sig do
      params(
        ...
        block: T.nilable(T.proc.params(object: ::SendgridEvent).void)
      ).returns(::SendgridEvent)
    end
    ...
    sig { returns(T::Array[::SendgridEvent]) }
    def destroy_all; end

    sig { params(conditions: T.untyped).returns(T::Boolean) }
    def exists?(conditions = :none); end

    sig { returns(T.nilable(::SendgridEvent)) }
    def fifth; end

    sig { returns(::SendgridEvent) }
    def fifth!; end

    sig { params(args: T.untyped).returns(T.untyped) }
    def find(*args); end

    sig { params(args: T.untyped).returns(T.nilable(::SendgridEvent)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::SendgridEvent) }
    def find_by!(*args); end
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T::Boolean) }
    def payload_previously_changed?; end
    ...
    def saved_change_to_sendgrid_id; end
    ...
    def sendgrid_id=(value); end

    sig { returns(T::Boolean) }
    def sendgrid_id?; end

    sig { returns(T.nilable(::String)) }
    def sendgrid_id_before_last_save; end

    sig { returns(T.untyped) }
    def sendgrid_id_before_type_cast; end

    sig { returns(T::Boolean) }
    def sendgrid_id_came_from_user?; end

    sig { returns(T.nilable([::String, ::String])) }
    def sendgrid_id_change; end

    sig { returns(T.nilable([::String, ::String])) }
    def sendgrid_id_change_to_be_saved; end

    sig { returns(T::Boolean) }
    def sendgrid_id_changed?; end

    sig { returns(T.nilable(::String)) }
    def sendgrid_id_in_database; end

    sig { returns(T.nilable([::String, ::String])) }
    def sendgrid_id_previous_change; end

    sig { returns(T::Boolean) }
    def sendgrid_id_previously_changed?; end

    sig { returns(T.nilable(::String)) }
    def sendgrid_id_previously_was; end

    sig { returns(T.nilable(::String)) }
    def sendgrid_id_was; end

    sig { void }
    def sendgrid_id_will_change!; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_sendgrid_id?; end
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::SendgridEvent } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::SendgridEvent, T::Enumerable[T.any(::SendgridEvent, T::Enumerable[::SendgridEvent])])
    ...
    sig do
      params(
        records: T.any(::SendgridEvent, Integer, String, T::Enumerable[T.any(::SendgridEvent, Integer, String, T::Enumerable[::SendgridEvent])])
      ).returns(T::Array[::SendgridEvent])
    end
    ...
    sig do
      params(
        other_array: T.any(::SendgridEvent, T::Enumerable[T.any(::SendgridEvent, T::Enumerable[::SendgridEvent])])
      ).returns(T::Array[::SendgridEvent])
    end
