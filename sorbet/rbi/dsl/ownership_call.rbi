...
# This is an autogenerated file for dynamic methods in `OwnershipCall`.
# Please instead update this file by running `bin/tapioca dsl OwnershipCall`.
...
class OwnershipCall
  ...
  class << self
    sig { returns(T::Hash[T.any(String, Symbol), T.any(TrueClass, FalseClass)]) }
    def statuses; end
  end

  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::OwnershipCall).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end
    ...
    sig do
      params(
        ...
        block: T.nilable(T.proc.params(object: ::OwnershipCall).void)
      ).returns(::OwnershipCall)
    end
    ...
    sig { returns(T::Array[::OwnershipCall]) }
    def destroy_all; end
    ...
    sig { returns(::OwnershipCall) }
    def fifth!; end

    sig { params(args: T.untyped).returns(T.untyped) }
    def find(*args); end

    sig { params(args: T.untyped).returns(T.nilable(::OwnershipCall)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::OwnershipCall) }
    def find_by!(*args); end
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::OwnershipCall } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::OwnershipCall, T::Enumerable[T.any(::OwnershipCall, T::Enumerable[::OwnershipCall])])
    ...
    sig do
      params(
        records: T.any(::OwnershipCall, Integer, String, T::Enumerable[T.any(::OwnershipCall, Integer, String, T::Enumerable[::OwnershipCall])])
      ).returns(T::Array[::OwnershipCall])
    end
    ...
    sig do
      params(
        other_array: T.any(::OwnershipCall, T::Enumerable[T.any(::OwnershipCall, T::Enumerable[::OwnershipCall])])
      ).returns(T::Array[::OwnershipCall])
    end
